        ...
        "last_spy" => "Last Spy",
         "activity_graph_intro" => 'In order to send datas to activity graph, you need to install <a href="https://board.fr.ogame.gameforge.com/index.php?thread/722955-oglight/&postID=11950870#post11950870" target="_blank">OGLight</a> and add your Team Key to OGL settings.<br>Then, you need to pin the target and check all targets\'s positions via the pinned menu.<br>',
        ...
        "activity_graph_not_available" => 'Not enougth data to create activity graph.<br><br>You need to install <a href="https://board.fr.ogame.gameforge.com/index.php?thread/722955-oglight/&postID=11950870#post11950870" target="_blank">OGLight</a>, pin the target and check all its positions to update activities.',
        "activity_oglight_data_not_available" => 'Not enougth OGLight data. You need to install <a href="https://board.fr.ogame.gameforge.com/index.php?thread/722955-oglight/&postID=11950870#post11950870" target="_blank">OGLight</a>.',
        ...
        "gee_presentation" => '<span class="medium_text">Galaxy Event Explorer will display galaxy by combining 2 data sources:
                               ...
                               <br><br>To collect data from ingame, You need to install <a href="https://board.fr.ogame.gameforge.com/index.php?thread/722955-oglight/&postID=11950870#post11950870" target="_blank">OGLight</a></span>',
