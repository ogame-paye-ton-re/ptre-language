<?php
    ...
    $lang_splash = ["splash_title" => "PTRE PRESENTATION",
...
"oglight_versus_infinity_2" => '<table class="main_tab" style="margin-bottom: 20px;" border="1" width="90%"><tr><td align="center"><b>Tool Feature</b></td><td align="center" width="150px"><span class="status_positif">OGLight</span></td><td align="center" width="150px"><b>Infinity</b></td><td align="center" width="150px"><b>EasyPTRE</b><br><a href="https://openuserjs.org/scripts/GeGe_GM/EasyPTRE" target="_blank">Install</a></td></tr>
        ...
        <tr><td><img src="/img/ogame/lf_human.png" width="20px"> [<a href="#easyptre">details</a>] Researchs and Lifeform sync to PTRE</td><td align="center"><span class="status_negatif">NO</span></td><td align="center"><span class="status_negatif">NO</span></td><td align="center"><span class="status_positif">YES</span></td></tr></table>',
'easyptre' => '<h3>EasyPTRE</h3><b>If you use PTRE</b>, you should install <a href="https://openuserjs.org/scripts/GeGe_GM/EasyPTRE" target="_blank">EasyPTRE</a>, no matter what is your main tool.<br><br>It\'s a tolerated tool that provides more PTRE features. Tool is compatible with AGR, OGL, OGI. It will adapt depending on what tool you use.',
'easyptre_friends_phalanx' => '<h3>Friends & Phalanx</h3>EasyPTRE provides informations regarding you aera, like friends positions, phalanx and last events from Galaxy Event Explorer, directly ingame.',
