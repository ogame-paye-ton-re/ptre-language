        ...
        "team_invit_key_comment" => "Puede proporcionar esta clave a todos los miembros de su equipo/alianza<br>para permitirles conectarse al sitio web de PTRE y obtener informes de espionaje privados.",
        "team_admin_key_title" => "clave de administrador",
        "team_admin_key_comment" => '<span class="status_warning">Solo para administradores (jefes, etc.).</span> <span class="status_negatif">¡Manténgalo seguro!</span><br>Esta clave debe guardarse en su navegador<br>para permitirle volver a conectarse como administrador la próxima vez (no funciona con navegación privada).<br>Debe guardar esta clave en otro lugar, en caso de que limpie sus "cookies".',
        "team_wo_key_title" => "Clave API-WO (discord)",
        "team_wo_key_comment" => 'Clave de asociación para el bot de Discord<br>Una vez que el bot de Discord esté instalado en su servidor de Discord (<a href="/?page=discord_integration">marque aquí</a>),<br>copie y pegue esta clave en un canal para que su servidor de Discord coincida con su equipo.',
        ...
        "team_member_no_discord_server" => '¡No hay ningún servidor de Discord asociado a tu equipo!<br>Pídele a un administrador (como creador de tu equipo) que lo haga.',
        ...
        "team_pub_connect_title" => "Conéctese a un equipo existente",
        "team_pub_connect_comment" => 'Introduce tu PTRE <span class="status_positif">Clave de equipo (o clave de administrador)</span>:<br><br>
            (Si no tienes ninguna clave, pregunta a tu creador del equipo.)',
        "team_pub_connect_button" => "Conéctate a mi equipo",

        "team_pub_create_title" => "Crear un nuevo equipo",
        "team_pub_create_comment" => 'Crear un equipo te permitirá <span class="status_positif">obtener una area privada</span> (en el sitio web de PTRE) donde podrá <span class="status_positif">agregar informes de espionaje privados</span>.<br>
            Those reports <span class="status_positif">solo se compartirá entre los miembros de tu equipo</span> (personas que obtengan la clave de invitación).<br><br>
            You may also <span class="status_positif">envía / comparte / investiga todos tus informes de espionaje directamente desde Discord</span>.<br><br>
        ...
        "team_pub_contact_msg" => '<span class="status_warning large_text">Si tiene algún problema (pérdida de clave PTRE, preguntas), comuníquese con GeGe al <a href="https://discord.gg/WsJGC9G" target="_blank">Servidor de discord PTRE</a>.</span>',
        ...
        "team_rename_comment" => 'Puedes cambiar el nombre de tu equipo: de 2 a 30 de longitud',
