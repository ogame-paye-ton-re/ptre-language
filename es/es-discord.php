        ...
        "discord_help_2" => "`!ptre !lang <lang>`: Establecer idioma predeterminado. Ej: `!ptre !lang en` / `!ptre !lang fr`\n",
        "discord_help_3" => "`!ptre !default <country>-<universe_id>` (example: `!ptre !default en-123`) :  Establecer universo predeterminado para todos los comandos de Discord.\n",
        "discord_help_4" => "`!ptre !push`: Establezca el canal predeterminado para la notificación de informes de espionaje: todos los informes (como los de OGLight, Infinity, EasyPTRE) se enviarán aquí.\n",
        "discord_help_5" => "`!ptre !details`: Alternar el modo detallado para informes de espionaje.\n",
        "discord_help_6" => "`!ptre !gala <rank>`: Habilitar notificaciones de galaxias (top 2000 máx.)\n",
        "discord_help_7" => "`!ptre !autochannel`: Habilite la detección automática de canales. Usa esta opción si estás jugando en varios universos en este Discord. PTRE encontrará el canal correcto para publicar: tendrás que cambiar el nombre de los canales como `ptre-fr-123`\n\n",
        "discord_help_8" => "**Commands:**\n",
        "discord_help_9" => "`!ptre`: Muestra ayuda.\n`!ptre palabra clave`: busca el nombre del juego que coincida con la palabra clave y muestra el resumen completo del jugador (no es necesario escribir el nombre completo del juego, puedes escribir `!ptre lex` para encontrar a Alexander).\n`!ptre \"ingame name\"`: Haga una búsqueda EXACTA y muestra el resumen completo del reproductor (debe escribir `!ptre \"alexander\"` para encontrar a alejandro).\n",
        "discord_help_10" => "`!ptre !last [!uni <country>-<universe_id>]`: Muestra los últimos informes de espionaje.\n",
        "discord_help_11" => "`!ptre !last !bunk [!uni <country>-<universe_id>]`: Muestra los últimos informes de espionaje del búnker.\n",
        "discord_help_12" => "`!ptre !top [!uni <country>-<universe_id>]`: Displays fleet top.\n",
        "discord_help_13" => "`!ptre !mb <moon size>`: Calcule la cantidad de estrellas de la muerte necesarias para una probabilidad del 100% de destruir la luna..\n\n",
